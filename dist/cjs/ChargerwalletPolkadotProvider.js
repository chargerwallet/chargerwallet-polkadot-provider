...
class ProviderPolkadot extends ProviderPolkadotBase_1.ProviderPolkadotBase {
    constructor(props) {
...
const registerPolkadot = (provider, name = 'ChargerWallet', version = '1.0.0') => {
    try {
        ...
        (0, extension_inject_1.injectExtension)(enableFn, { name: name !== null && name !== void 0 ? name : 'ChargerWallet', version: version !== null && version !== void 0 ? version : '1.0.0' });
    }
    catch (error) {
        console.error(error);
    }
};
exports.registerPolkadot = registerPolkadot;
